...
<html>
    ...
    <%
        int funcionario = Integer.parseInt(request.getParameter("idFuncionario"));
        int entregador = Integer.parseInt(request.getParameter("idEntregador"));
    ...
    <body>
        ...
        <form action = "index.jsp" method = "post">
            <p>Nome:
                <%= new DefesaIO().defesaPizza(funcionario, cliente, entregador, sexo, ano, mes1, mes2) %></p>
